...
Browser 테스트는 Instance Part Window·공동 집필 Part Section v2 레이아웃의 기본값, 입력 경계, v1 마이그레이션, 원자 저장, 동시 저장 직렬화와 손상 파일 처리에 더해 Browser/Core 기본값 일치, 최소화·접기·순서 이동·인접 크기 조절 순수 함수와 DOM·스타일·명령 연결을 검증한다.
