...
async function AssertInstalledLayout(installRoot: string): Promise<void> {
  await Promise.all([
    ...
    access(join(installRoot, "client", "resources", "fonts", "font-manifest.json")),
    access(join(installRoot, "client", "resources", "fonts", "NanumGothic.ttf")),
    access(join(installRoot, "client", "resources", "fonts", "NanumGothicBold.ttf")),
    access(join(installRoot, "client", "resources", "fonts", "D2Coding-Ver1.3.2-20180524-all.ttc")),
    access(join(installRoot, "client", "resources", "fonts", "licenses", "NAVER-NANUM-LICENSE-KO.txt")),
    access(join(installRoot, "client", "resources", "fonts", "licenses", "D2CODING-OFL-1.1.txt")),
